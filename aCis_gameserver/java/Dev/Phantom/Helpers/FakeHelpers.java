...
public class FakeHelpers
{
	...
	public static List<ClassId> getThirdClasses()
	{
		...
		/*
		 * classes.add(ClassId.EVAS_SAINT); classes.add(ClassId.SHILLIEN_TEMPLAR); classes.add(ClassId.SPECTRAL_DANCER); classes.add(ClassId.GHOST_HUNTER); classes.add(ClassId.PHOENIX_KNIGHT); classes.add(ClassId.HIEROPHANT); classes.add(ClassId.EVAS_TEMPLAR); classes.add(ClassId.SWORD_MUSE);
		 * classes.add(ClassId.DOOMCRYER); classes.add(ClassId.FORTUNE_SEEKER); classes.add(ClassId.MAESTRO);
		 */
