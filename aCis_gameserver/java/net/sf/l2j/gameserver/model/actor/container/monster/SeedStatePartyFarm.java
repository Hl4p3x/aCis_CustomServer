...
/**
 * A container holding all related informations of a {@link PartyFarm} seed state.<br>
 * <br>
 * A seed occurs when a {@link Player} uses a seed over a Monster.
 */
public class SeedStatePartyFarm
{
	...
	public SeedStatePartyFarm(PartyFarm owner)
	{
		_owner = owner;
	}
